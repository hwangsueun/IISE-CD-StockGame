...
| `Main Screen.html` | `pages/MainPage.jsx` + `StatusBar` | **✅ 이식 완료 (2026-07-08)** — bg_room + 버튼 6종 + 상태바/HUD/헤드라인 패널, 원본 좌표·수치 유지 |
...
| D-b | ~~캘린더 월 그리드 UI~~ **✅ 완료 (2026-07-08)** — 디자인 cal-overlay 그리드/요일/메모 사이드 이식 | `CalendarModal` |
